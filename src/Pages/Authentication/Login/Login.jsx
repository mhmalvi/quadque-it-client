...
/*   document.title = "QIT -Log In";
  ...
  return (
    <div className="lg:flex justify-center items-center h-screen my-10">
      <div  className={`absolute z-50 container max-w-sm h-[85%] rounded-tl-lg rounded-bl-lg p-3 bg-[#0D0D2B] shadow-lg ${boxLeft ? ("-translate-x-[50%] rounded-tl-lg rounded-bl-lg duration-500") : ("translate-x-[50%] rounded-tl-none rounded-bl-none rounded-tr-lg rounded-br-lg duration-500")}`}>
        <img src={Psychic} alt="" className=""/>
      ...
      <div className="container max-w-sm h-[85%] border border-gray-200  rounded-tl-lg rounded-bl-lg p-3 bg-white shadow-lg">
        <div className="flex justify-end">
          <div onClick={toogleSignupLogin} className="w-32 text-white bg-brand-color bg-opacity-80 hover:bg-opacity-100 duration-200 text-center cursor-pointer rounded-full shadow-lg px-3">
            <span className="text-sm">Login here</span>
          </div>
        </div>
...
{/*                 <ForgotPassword
      ...
      <div className="container max-w-sm h-[85%] border border-gray-200  rounded-tr-lg rounded-br-lg p-3 bg-white  shadow-lg">
        <div onClick={toogleSignupLogin} className="w-32 text-white bg-brand-color bg-opacity-80 hover:bg-opacity-100 duration-200 text-center cursor-pointer rounded-full shadow-lg px-3">
          <span className="text-sm">Sign Up here</span>
        </div>
        <div className="pb-3 pt-8">
          <div className="flex flex-col items-center">
            <img src={Logo} alt="" />
