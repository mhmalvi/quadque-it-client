      ...
      <div className="w-1/2 flex-col justify-center m-auto">
        ...
        <div className="flex justify-center gap-6 pt-14 pb-24">
          <div className="flex-col text-center">
            <div className="w-38 h-29 border-2 rounded-lg p-3">
              <span className="text-5xl font-bold"><CountUp duration={2.75} end={6} /></span>
              <br />
              Months
            </div>
          ...
          <div className="flex-col text-center">
            <div className="w-38 h-29 border-2 rounded-lg p-4">
              <span className="text-5xl font-bold"><CountUp duration={2.75} end={48} /></span>
            </div>
            <div className="pt-5">Lectures</div>
          </div>
          <div className="flex-col text-center">
            <div className="w-38 h-29 border-2 rounded-lg p-4">
              <span className="text-5xl font-bold"><CountUp duration={2.75} end={30} suffix="+"/></span>
            </div>
        ...
        <div className="m-auto">
          ...
          <div className="text-center pb-18">
            To be a successful graphic designer you need to have
            training in quality curriculum as well as project based work
            experience and a good idea about the marketplace. So none of
            these have been included together in our course module. From
            the graphic design course you will learn to design any ad,
            banner, t-shirt design, product using Adobe Photoshop and
            Adobe Illustrator. In addition, you get the opportunity to
            use modern labs for project-based work. By completing the
            course in this way, you will have real work experience,
            which will help you achieve quick success in the
            marketplace.
          </div>
        </div>
        <div className="">
          <div className="text-center text-4xl pb-13">
           Special services
          </div>
          <div className="flex text-center gap-6 pb-6">
            <div className="flex-col bg-[#2F327D10] rounded-lg p-7">
              <div className=""><Icons.Support/></div>
              <div className="text-xl py-2">Marketplace support</div>
              <div className="text-base">Our new seminar in wordpress 26 Our new seminar in wordpress 26 June Our new wordpress 26 JuneJune Our new wordpress 26 June Our new seminar in wordpress 26 June Our new wordpress 26 June</div>
            </div>
            <div className="flex-col bg-[#2F327D40] rounded-lg p-7">
              <div><Icons.Guidance/></div>
              <div className="text-xl py-2">Marketplace support</div>
              <div className="text-base">Our new seminar in wordpress 26 Our new seminar in wordpress 26 June Our new wordpress 26 JuneJune Our new wordpress 26 June Our new seminar in wordpress 26 June Our new wordpress 26 June</div>
            </div>
          </div>
          <div className="flex text-center gap-6">
            <div className="flex-col bg-[#2F327D60] rounded-lg p-7">
              <div className=""><Icons.Certificate/></div>
              <div className="text-xl py-2">Marketplace support</div>
              <div className="text-base">Our new seminar in wordpress 26 Our new seminar in wordpress 26 June Our new wordpress 26 JuneJune Our new wordpress 26 June Our new seminar in wordpress 26 June Our new wordpress 26 June</div>
            </div>
