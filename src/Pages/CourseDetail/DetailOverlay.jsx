        ...
        <div className="w-1/2 flex-col justify-center m-auto">
          ...
          <div className="m-auto">
            ...
            <div className="text-center pb-18">
              ...
              product using Adobe Photoshop and Adobe Illustrator. In addition,
              you get the opportunity to use modern labs for project-based work.
              By completing the course in this way, you will have real work
              experience, which will help you achieve quick success in the
              marketplace.
            </div>
          </div>
          <div className="">
            ...
            <div className="flex text-center gap-6 pb-6">
              <div className="flex-col bg-[#2F327D10] rounded-lg p-7">
                ...
                <div className="text-base">
                  ...
                  June Our new seminar in wordpress 26 June Our new wordpress 26
                  June
                </div>
              </div>
