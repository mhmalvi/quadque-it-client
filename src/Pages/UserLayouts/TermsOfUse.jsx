  ...
  return (
    <>
      ...
      <div className="w-full max-w-screen-2lg mx-auto lg:my-10">
        ...
        <div className="text-lg font-semibold pb-5">Code of Conduct For Service Providers / Users</div>
        <div className="pb-5">
        ...
        <div className="font-semibold pb-5">Instances:</div>
        <div className="pb-5">
            ...
            <br /><br />
            Spam (Unsolicited Commercial email) - This Platform's spam policy applies only to unsolicited commercial messages sent by its Users. This Platform Users are not allowed to send spam messages to other Users.
            <br /><br />
            Offers to buy or sell outside of this Platform - This Platform prohibits email offers to buy or sell listed products outside of the platform. Offers of this nature are a potential fraud risk for both Buyers and Sellers.
            <br /><br />
            This Platform's policy prohibits User-to-User threats of physical harm via any method including, phone, email and on our public message boards.
            <br /><br />
