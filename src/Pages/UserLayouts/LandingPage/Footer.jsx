        ...
        <Fade left cascade>
          <div className="md:w-3/12 pb-4">
            ...
            <div className="text-sm text-justify pb-8">
              This is your opportunity to learn the most demandable IT and
              digital marketing skills from some of the best experts in the
              industry. <br />
              Feel free to get in touch with our team. We would love to hear
              from you!
            </div>
            <div className="flex">
