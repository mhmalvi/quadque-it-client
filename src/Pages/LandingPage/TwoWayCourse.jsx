...
export default function TwoWayCourse() {
  return (
    <div className="w-full pb-40">
      <div className="bg-home-color text-white text-center font-poppins mx-10 rounded-3xl pb-16 px-20">
        <div className="text-4xl font-semibold pt-8 pb-5">Two-way courses</div>
        <div className="w-1/2 text-lg m-auto">
        ...
        <div className="flex justify-center text-white pt-13 gap-6">
          <div className="flex-col bg-home-color rounded-3xl">
            ...
            <div className="p-5">
              ...
              <div className="w-1/2 border border-white rounded-full mx-auto text-xl py-4 my-4">
                Online Courses
              </div>
            </div>
          </div>
