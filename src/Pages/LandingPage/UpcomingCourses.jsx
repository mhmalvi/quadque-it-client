...
export default function UpcomingCourses() {
  return (
    <div className="w-full pb-24">
      <div className="text-center font-poppins mx-10 rounded-3xl py-24 px-20">
          ...
          <div className="flex-col bg-home-color w-1/3 rounded-3xl">
            ...
            <div className="flex-col pt-5">
                <div className="flex justify-between">
                    <div className="bg-[#23BDEE] text-[#23BDEE] bg-opacity-50 rounded-2xl px-4">5.6.22</div>
                    <div className="text-xl py-2">15000 tk</div>
                </div>
            </div>
            <div className="text-2xl pt-2 left-0">Web Design</div>
            <div className="mx-4">Our new seminar in wordpress 26 June Our new wordpress 26 June</div>
          </div>
          <div className="flex-col bg-home-color w-1/3 rounded-3xl">
            <div className="flex">
            ...
            <div>Our new seminar in wordpress 26 June Our new wordpress 26 June</div>
          </div>
          <div className="flex-col bg-home-color w-1/3 rounded-3xl">
            <div className="flex">
