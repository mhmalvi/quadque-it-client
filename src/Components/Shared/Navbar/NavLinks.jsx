...
const NavLinks = () => {
  ...
  return (
    <>
      <div className="lg:flex z-50 bg-black bg-opacity-30 backdrop-filter backdrop-blur-lg lg:backdrop-filter-none lg:bg-transparent border border-white border-opacity-30 lg:border-none shadow-2xl shadow-[#ffffff20] lg:shadow-none lg:text-white text-center text-xl lg:text-base rounded-md cursor-pointer mx-2">
        {links?.map((link) => (
